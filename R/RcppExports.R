...
qatd_cpp_count1 <- function(texts_, types_, sizes_, nested) {
    .Call(quanteda_qatd_cpp_count1, texts_, types_, sizes_, nested)
}

qatd_cpp_count2 <- function(texts_, types_, sizes_) {
    .Call(quanteda_qatd_cpp_count2, texts_, types_, sizes_)
}

qatd_cpp_sequences <- function(texts_, types_, count_min, sizes_, method, smoothing, nested) {
    .Call(quanteda_qatd_cpp_sequences, texts_, types_, count_min, sizes_, method, smoothing, nested)
}
